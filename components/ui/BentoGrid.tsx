    ...
    >
      <div className={`${id === 6 && 'flex justify-center'} h-full`}>
        ...
        >
          ...
          {id === 2 && <GlobeDemo />}
          {id === 3 && (
            <div className="flex gap-2 lg:gap-5 absolute w-fit -right-3 lg:-right-2 ">
              <div className="flex flex-col gap-1 md:gap-3 lg:gap-8">
                {['React.js', 'Next.js', 'Three.js'].map((item) => (
                  <span
                    key={item}
                    className="py-2 lg:py-4 lg:px-3 px-3 text-xs lg:text-base opacity-50 lg:opacity-100 rounded-lg text-center bg-[#10132E] text-[#888995]"
                  >
                    {item}
                  </span>
                ))}
              ...
              <div className="flex flex-col gap-2 md:gap-3 lg:gap-8">
                <span className="lg:py-4 lg:px-3 py-4 px-3  rounded-lg text-center bg-[#10132E]"></span>
                {['Node.js', 'Tailwind.css', 'MongoD'].map((item) => (
                  <span
                    key={item}
                    className="py-2 lg:py-4 lg:px-3 px-3 text-xs lg:text-base opacity-50 lg:opacity-100 rounded-lg text-center bg-[#10132E] text-[#888995]"
                  >
